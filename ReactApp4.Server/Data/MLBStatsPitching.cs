...
{
    public class MLBStatsPitching : IMLBStatsPitching
    {
        ...
        [Column("number_of_pitches")] public double? NumberOfPitches { get; set; }
        [Column("games_started")] public double? GamesStarted { get; set; }
        ...
        [Column("wins")] public double? Wins { get; set; }
        [Column("losses")] public double? Losses { get; set; }
        [Column("saves")] public double? Saves { get; set; }
        [Column("save_opportunities")] public double? SaveOpportunities { get; set; }
        [Column("holds")] public double? Holds { get; set; }
        [Column("blown_saves")] public double? BlownSaves { get; set; }
        [Column("earned_runs")] public double? EarnedRuns { get; set; }
        [Column("outs")] public double? Outs { get; set; }
        ...
        [Column("inherited_runners")] public double? InheritedRunners { get; set; }
        [Column("inherited_runners_scored")] public double? InheritedRunnersScored { get; set; }
        [Column("passed_ball")] public double? PassedBalls { get; set; }
